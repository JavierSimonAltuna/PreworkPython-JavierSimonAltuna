...
FROM Productos
INNER JOIN DetallesPedido ON Productos.producto_id = DetallesPedido.producto_id;"""
...
"""SELECT Productos.*, DetallesPedido.*
FROM Productos
INNER JOIN DetallesPedido ON id = id;"""
