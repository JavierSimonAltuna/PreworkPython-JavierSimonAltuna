...
"""ERROR:  La llave (cliente_id)=(1) no está presente en la tabla «clientes».inserción o actualización en la tabla «pedidos» viola la llave foránea «pedidos_cliente_id_fkey» 
...
"""LO RESUELVO AÑADIENDO EL CLIENTE QUE HABIA SIDO ELIMINADO EN EL EJERCICIO 4 A LA TABLA DE CLIENTES"""
...
JOIN Productos ON Pedidos.producto = Productos.producto;"""